...
def arg_parse():
    ...
    parser.add_argument('--model_path', type=str, default='lm_rgcn_q8_with2lr.pt')
    parser.add_argument('--samples_file', type=str, default='lm_rgcn_q8_with2lr.txt')
...
if __name__ == '__main__':
    args = arg_parse()
    wandb.init(project="pssp_main_q8", name="lm_rgcn_with2lr_q8")
    config = {
        "epochs": args.epochs,
